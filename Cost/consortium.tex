%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Consortium for the COST network
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\item Miguel Angel Marco Buzunariz (Profesor ayudante doctor en la universidad de Zaragoza)
  ...
  %github: miguelmarco
  %Main contributions in Sage:
  % - Free and finitely presented groups
  % - Braid groups
  % - GSoc 2013 mentor of Veronica Suaste (coding theory)
  % - GSoc 2014 mentor of Amit Jamagadni (knot theory)
...
\vspace{-1.2ex}
\subsection*{Université Bordeaux: LaBRI (%Laboratoire Bordelais de Recherche en informatique,
