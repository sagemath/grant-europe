...
%\subsection*{Observatoire de Paris : IMCCE (%Institut de mécanique céleste et de calcul des éphémérides, UMR8028)}

%\begin{itemize}
\item Micka\"el Gastineau (IR CNRS, \MATH/\CS, 10\%): %\\
  SCSCP, multivariate polynomials.
%\end{itemize}
