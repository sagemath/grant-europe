...
* Advisory Board
  ...
  - Hongrie (confirmed)
  - ???
* Finalisation avec Eugenia
** DONE Suprimmer Audit costs et adapter les nombres en conséquence dans
   - State "DONE"       from ""           [2015-01-13 mar. 13:30]
    les "ressources to be commited"
** Management Level Description of Resources and Budget
** Finaliser l'ordre des participants / cohérence des noms
...
* Faire rentrer les objectifs dans 4 pages?
* Specific requests of the call.
* Review KPI with Alexander
* DONE Vincent's mail
  - State "DONE"       from ""           [2015-01-13 mar. 14:38]
* DONE Wolfram's situation
  - State "DONE"       from ""           [2015-01-13 mar. 14:35]
* Systematic replacements
  ize -> ise
  3d -> 3D
* Abstract
** Mettre à jour
** Bien mettre en valeur le fait qu'il y aura réellement des VRE construits
   (les démonstrateurs)
   C'est pas seulement du travail en amont.
* Contact other VRE
* Risk
...
* Checklist
- [ ] Mettre à jour l'abstract
- [ ] Resources, feuilles de budget, engagement
- [ ] Table 3.4.3 Ressource summary
* Vispy
* Modèle économique
* Resources: réordonner et numéroter les participants
* TODO Éthique:
  - Mentionner la page où William est mentionné (Advisory Board)
  - Mentionner la page sur les workshops en afrique
* Third party table
