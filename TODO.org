...
* Contact English participant / admins for proofreading
* Risk: add item about joint work with the community
...
* DONE Check requirements on tasks labeling and fix style file if needed
  - State "DONE"       from ""           [2015-01-10 sam. 16:10]
* Short budget description for Orsay
* Short description of main tasks for Orsay, Versailles, Kaiserslautern
* Flesh up the description of the to-be-hired people
* Read self-evaluation short file h2020-call-ef-ria_einfra_en.pdf
* Check Valeriya's comments
* Mail about Gantt chart
* Risk: will the infrastructure actually match the needs of the end users

  Measure: We are users; steering and governance is naturally by
  end-users; because we provide a kit, users have the flexibility to
  adapt the infrastructure to their needs.
